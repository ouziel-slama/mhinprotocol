...
mod tests {
    ...
    fn constants_expose_expected_parameters() {
        assert_config(MhinConfig::MAINNET, 6, 4_096, b"MHIN");
        assert_config(MhinConfig::TESTNET4, 2, 4_096, b"MHIN");
        assert_config(MhinConfig::SIGNET, 2, 4_096, b"MHIN");
        assert_config(MhinConfig::REGTEST, 2, 4_096, b"MHIN");
    }
